...
import { SearchTokenAutocomplete } from '@dexkit/ui/modules/swap/components/SearchTokenAutocomplete';
...
// CollectionItemAutocomplete will be imported from apps/dexappbuilder at runtime
// For now, we'll use a type declaration
declare const CollectionItemAutocomplete: React.ComponentType<{
  onChange: (coll: any) => void;
  value: {
    chainId?: number;

import { BooleanInput, Button, Edit, SimpleForm, TextInput, TopToolbar, useNotify, useRecordContext } from "react-admin";
...
const FeatUsageActions = () => {
  ...
  return (
    <TopToolbar>
      <Button color="error" variant="contained" onClick={handleRemoveCustomDomain}>Remove Custom Domain</Button>
    </TopToolbar>
  )
};

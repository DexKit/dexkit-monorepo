...
- Name: EditionStake Contract UI Tests >> Contract has expected sections
- Location: C:\Users\eliec\Desktop\dev\DexKit\master\apps\dexappbuilder\tests\e2e\contract-ui.spec.ts:58:3

# Error details

```
Error: locator.isVisible: Error: strict mode violation: getByText(/stake|staking|rewards/i) resolved to 2 elements:
    ...
    2) <span class="MuiChip-label MuiChip-labelMedium css-6od3lo-MuiChip-label">Edition Stake</span> aka getByText('Edition Stake')

Call log:
    - checking visibility of getByText(/stake|staking|rewards/i)

    at C:\Users\eliec\Desktop\dev\DexKit\master\apps\dexappbuilder\tests\e2e\contract-ui.spec.ts:66:48
```

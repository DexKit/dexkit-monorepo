            ...
            <>
              ...
              <Grid item xs={12} sm={6}>
                <Field
                  ...
                  label={
                    <FormattedMessage
                      id="max.total.background.color"
                      defaultMessage="Max Total Background Color"
                    />
                  }
                  placeholder="#f5f5f5"
                  fullWidth
              ...
              <Grid item xs={12} sm={6}>
                <Field
                  ...
                  label={
                    <FormattedMessage
                      id="max.total.border.color"
                      defaultMessage="Max Total Border Color"
                    />
                  }
                  placeholder="#cccccc"
                  fullWidth
              ...
              <Grid item xs={12} sm={6}>
                <Field
                  ...
                  label={
                    <FormattedMessage
                      id="available.remaining.background.color"
                      defaultMessage="Available Remaining Background Color"
                    />
                  }
                  placeholder="#4caf50"
                  fullWidth
              ...
              <Grid item xs={12} sm={6}>
                <Field
                  ...
                  label={
                    <FormattedMessage
                      id="available.remaining.border.color"
                      defaultMessage="Available Remaining Border Color"
                    />
                  }
                  placeholder="#388e3c"
                  fullWidth

...
import { Accordion, AccordionDetails, AccordionSummary, Autocomplete, Box, Button, FormControl, Grid, IconButton, InputLabel, MenuItem, TextField as MuiTextField, Typography } from '@mui/material';
...
export default function DexGeneratorTokenDropForm({
  ...
  return (
    <Formik
      initialValues={
        section && section.type === 'token-drop' ? {
                      ...
                      <Grid item xs={12}>
                        ...
                        <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.25, justifyContent: 'flex-start' }}>
                          <CompactColorField
                            ...
                            label={<FormattedMessage id="max.total.background.color" defaultMessage="Max Total Background" />}
                            placeholder="#f5f5f5"
                          />
                          <CompactColorField
                            name="customStyles.statsColors.maxTotalBorder"
                            label={<FormattedMessage id="max.total.border.color" defaultMessage="Max Total Border" />}
                            placeholder="#cccccc"
                          />
                          <CompactColorField
                            name="customStyles.statsColors.availableRemainingBackground"
                            label={<FormattedMessage id="available.remaining.background.color" defaultMessage="Available Background" />}
                            placeholder="#4caf50"
                          />
                          <CompactColorField
                            name="customStyles.statsColors.availableRemainingBorder"
                            label={<FormattedMessage id="available.remaining.border.color" defaultMessage="Available Border" />}
                            placeholder="#388e3c"
                          />
                        </Box>
                      </Grid>
                      ...
                      <Grid item xs={12}>
                        <Box sx={{ display: 'flex', justifyContent: 'center', mt: 3 }}>
                          <Button
                            ...
                            onClick={() => {
                              // Reset all custom styles to default values
                              setFieldValue('customStyles', {
                                backgroundColor: {
                                  type: 'solid',
                                  solid: '#ffffff',
                                  gradient: {

...
const THIRDWEB_CONTRACT_LIST: {
  ...
  slug: string;
    ...
    },
    {
      name: 'StakeERC721',
      description:
        'This contract allows users to stake their ERC721 NFTs and get ERC-20 tokens as staking rewards.',
      publisherIcon: THIRDWEB_ICON_URL,
      publisherName: 'ThirdWeb',
      slug: 'NFTStake',
    },
...
(FormsPageComponent as any).getLayout = function getLayout(page: any) {

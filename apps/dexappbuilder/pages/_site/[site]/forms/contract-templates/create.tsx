...
const CreateContractTemplatePageComponent = DynamicImport(
  () => import('@/modules/forms/CreateContractTemplatePageComponent'),
  { ssr: false }
);

export default function CreateTemplatePage() {
  return <CreateContractTemplatePageComponent />;
}
